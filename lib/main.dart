...
class _MainAppState extends State<MainApp> {
    ...
    return MaterialApp(
      ...
      home: LayoutBuilder(
        builder: (context, constraints){
          //lower wideWebLayout minWidth, adjust card sizes
          if(constraints.maxWidth > 1400){
            return wideWebLayout(screenSize);
          }else if(constraints.maxWidth > 1000){
            return narrowWebLayout(screenSize);
          }else{
            return Text("hi");
          }
        }
  ...
  Widget wideWebLayout(Size screenSize) {
    return Scaffold(
  ...
  Widget narrowWebLayout(Size screenSize) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 245, 245, 245),
      appBar: AppBar(
        actions: [
